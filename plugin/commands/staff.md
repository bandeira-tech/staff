...
4. **Execute.**
   ...
   clearer). When dispatching subagents, hand them references to
   the relevant traits / roles / plays / teams under the staff root
   rather than copy-pasting bodies, per the SKILL's "Dispatching
   Agents" guidance.
